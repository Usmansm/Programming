...
?>
	...
	<div class="table-responsive">
		<table class="table table-striped table-hover table-bordered table-highlight">
			<thead>
				<tr>
					<th><?php echo $this->Label->get('general.id'); ?></th>
			...
			<tbody>
				...
				<tr>
				<td><?php echo $this->Html->link($obj['SecurityUser']['identification_no'], array('action' => '../Guardians/view', $obj['SecurityUser']['id'])) ?></td>
