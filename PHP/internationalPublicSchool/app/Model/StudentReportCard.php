		...
		if (isset($selectedYear)) {
			...
			$data = array(
				...
				"datablock1" => array(
					...
					'studentId' => array(
						'title' => $this->Message->getLabel('SecurityUser.identification_no'),
						'data' => $studentData['SecurityUser']['identification_no']
					),
					'studentNo' => array(
						'title' => $this->Message->getLabel('Student.student_no'),
						'data' => $studentData['StudentReportCard']['id']
					),
					'studentClass' => array(
