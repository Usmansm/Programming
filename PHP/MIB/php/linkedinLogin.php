...
if(isset($_SESSION['userId'])){
	if($_GET['importLi'] == true){
		define('REDIRECT_URI', $config['root'].'php/linkedinLogin.php?userId='.$_SESSION['userId'].'&importLi=true');
	}
	else{
...
if(isset($_GET['userId'])){
	if($_GET['importLi'] == true){
	define('REDIRECT_URI', $config['root'].'php/linkedinLogin.php?userId='.$_GET['userId'].'&importLi=true');
	}
	else{
