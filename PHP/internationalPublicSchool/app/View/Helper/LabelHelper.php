...
class LabelHelper extends AppHelper {
	public $messages = array(
		...
		'general' => array(
			...
			'id' => 'Identification',
			'identity' => 'Identity',
			'idNoNotFound' => 'Identification No or Name is not found',
			'idPlaceholder' => 'Identification No, First Name or Last Name',
			'idPlaceholder2' => 'Identification No or Name',
			'inactive' => 'Inactive',
		...
		'student' => array(
			...
			'state' => 'Student State',
			'studentNo' => 'Student No', // will be removed
