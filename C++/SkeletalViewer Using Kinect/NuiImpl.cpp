...
int select;
extern Vector4 trap_vector;
extern Vector4 trap_vector1;
...
void CSkeletalViewerApp::Nui_GotDepthAlert( )
{
    ...
    if ( 0 != LockedRect.Pitch )
    {
		...
		memcpy( my,  m_rgbWk,frameWidth * frameHeight*4);
...
void CSkeletalViewerApp::Nui_DrawSkeleton( NUI_SKELETON_DATA * pSkel, HWND hWnd, int WhichSkeletonColor )
{
	...
	trap_vector=pSkel->SkeletonPositions[select];
	trap_vector1=pSkel->SkeletonPositions[7];
