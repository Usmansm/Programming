...
class StaffAttendanceDay extends AppModel {
	...
	public function staff_edit(){
		...
		$this->controller->Navigation->addCrumb($this->Message->getLabel('staff.title'), array('this->controller'=>'Attendance', 'action' => 'staff', $selectedDate));
	...
	public function attendance_view($controller, $params){
		...
		$controller->set('header', $data['SecurityUser']['first_name'].' '.$data['SecurityUser']['last_name'].' ('.$data['Staff']['staff_no'].')');
	}
