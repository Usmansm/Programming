...
//	}
	 ...
	 * @param animation
	 */
	public static void initAnimation(Animation animation) {
		...
		origin.x = origin.x + sloganImage.getWidth(null) - 1;
 ...
 class ProjectileSprite implements ISprite {
