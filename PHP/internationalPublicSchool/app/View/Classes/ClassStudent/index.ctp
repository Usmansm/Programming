...
?>
	...
	<table class="table table-striped table-hover table-bordered table-highlight">
		<thead>
			<tr>
				<?php
				echo $this->FormUtility->getSort($sort, 'Student.student_no');
				echo $this->FormUtility->getSort($sort, 'SecurityUser.identification_no');
		...
		<tbody>
			...
			<tr>
				<td><?php echo $this->Html->link($obj['Student']['student_no'], array('controller' => 'Students', 'action' => 'view', $obj['Student']['id'])); ?></td>
				<td><?php echo $obj['SecurityUser']['identification_no']; ?></td>
