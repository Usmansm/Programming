            ...
            <?php 
				if(!empty($teachersData)){
					...
					foreach($teachersData as $teacher){
						...
						$teacherStaffNo = ' ('.$teacher['Staff']['staff_no'].')';
						
						$teacherStr .= $this->Html->link($teacherFullName.$teacherStaffNo, array('controller'=> 'Staff', 'action'=> 'view', $teacher['Staff']['id']), array('target' => '_new'));
					}	
