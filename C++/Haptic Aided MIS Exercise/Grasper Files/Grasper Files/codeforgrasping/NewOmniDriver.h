...
#include <math.h>
#include <C:\sofa\applications\sofa\gui\qt\viewer\SofaViewer.h>
...
public:
 ...
 bool grasperActivated;
  bool graspClose;
  // storages for GraspFunction Objects and their indices
  std::vector<sofa::gui::GraspFunction*> gFuncVecRight;
  std::vector<sofa::gui::GraspFunction*> gFuncVecLeft;
 // GraspFunction* gFunc;
  unsigned int graspInsideIndex[18];

  double breakLengthTran;
  double breakLengthPitch;
  double breakLengthYaw;
  //zohaib's work ends
	//void moveLaparoscopicByOmni(int , int );
		...
		sofa::gui::qt::viewer::SofaViewer* sF;
