...
class ClassStudent extends AppModel {
	...
	public function sort($conditions, $by, $direction) {
		$options = array(
			'recursive' => -1,
			'fields' => array(
				'ClassStudent.id', 'ClassStudent.education_grade_id', 'Student.id', 'Student.student_no', 'StudentCategory.name',
				'SecurityUser.identification_no', 'SecurityUser.first_name', 'SecurityUser.middle_name', 'SecurityUser.last_name', 'EducationGrade.name'
			),
			'joins' => array(
				array(
					'table' => 'students',
		...
		if (!empty($by)) {
			...
			$order = array('Student.student_no' => 'asc');
		}
		$options['order'] = $order;
	...
	*/
	...
	public function getStudentsByClassGrade($classId, $gradeId) {
		$data = $this->find('all', array(
			'fields' => array('Student.id', 'ClassStudent.id', 'ClassStudent.student_category_id', 'StudentCategory.name', 'SecurityUser.identification_no',  'Student.student_no', 'SecurityUser.first_name', 'SecurityUser.last_name'),
			'recursive' => -1,
			'joins' => array(
				array(
					'table' => 'students',
	...
	public function getStudentsById($id) {
		$data = $this->find('first', array(
			'fields' => array('Student.id', 'ClassStudent.id', 'ClassStudent.education_grade_id','ClassStudent.student_id', 'ClassStudent.student_category_id', 'ClassStudent.student_category_id', 'StudentCategory.name', 'SecurityUser.identification_no',  'Student.student_no', 'SecurityUser.first_name', 'SecurityUser.last_name',
	...
	public function getStudentsByClass($classId) {
		$data = $this->find('all', array(
			'fields' => array('Student.id', 'ClassStudent.id', 'ClassStudent.student_category_id', 'StudentCategory.name', 'Student.student_no', 'StudentStatus.name', 'SecurityUser.identification_no', 'SecurityUser.first_name', 'SecurityUser.middle_name', 'SecurityUser.last_name', 'SecurityUser.gender'),
			'recursive' => -1,
			'joins' => array(
				array(
					'table' => 'students',
