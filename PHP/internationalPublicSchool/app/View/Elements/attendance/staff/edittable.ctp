        ...
        <table class="table table-striped table-hover table-bordered table-highlight">
            <thead>
                 <tr class="multiple-line">
                    <th rowspan="2"><?php echo $this->Label->get('staff.no');  ?></th>
			...
			<tbody>
                ...
                ?>
                <tr>
                	<td><?php echo $this->Html->link($staff['Staff']['staff_no'], '/Staff/view/'.$staff['Staff']['id'], array('target' => '_blank'));?></td>
                	<td><?php echo $staff['SecurityUser']['first_name']?></td>
            ...
            <div class="overflow-scroll">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo $staff['Staff']['staff_no']?></td>
