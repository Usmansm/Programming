...
<select name="famtype" id="famtype">
...
<br /><label for="famphone" ><span class="addfam_title" >Online Link1: </span></label><br />
<input type="text" id="Link1" /><br />
<br /><label for="famphone" ><span class="addfam_title" >Online Link2:</span></label><br />
<input type="text" id="Link2" /><br />
</div>
...
<textarea id="famnotes" ></textarea><br />
</div>
HTML;
