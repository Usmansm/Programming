...
function createUser($pdo, $username, $password) {
	...
	$insertSQL = "INSERT INTO `security_users` (id, username, password, identification_no, first_name, middle_name, last_name, gender, super_admin, status, created_user_id, created) VALUES (%s)";
