...
if ($_SESSION["userId"] != "") {
	...
	$catFb = array();
	$catLi = array();
	$countRows=$mysql->query("SELECT * FROM user_friend_detail WHERE userId = '" . $_SESSION['userId'] . "' and FriendFirstName regexp '^[".$_GET['prevAlpha']."]' ");
	$totalRows=$countRows -> num_rows;
	$limitFirst=$totalRows-1-$_GET['firstLimit'];
	if($limitFirst<0){
	$limitFirst=0;
	}
	$query = "SELECT * FROM user_friend_detail WHERE userId = '" . $_SESSION['userId'] . "' and FriendFirstName regexp '^[".$_GET['prevAlpha']."]' ORDER BY FriendFirstName ASC, FriendLastName ASC  limit ".$limitFirst.", ".$_GET['firstLimit'];
	...
	/*--------------------------------------------------------------------------------------------------*/
	$query = "SELECT * FROM user_friend_detail WHERE userId = '" . $_SESSION['userId'] . "' and FriendFirstName like '".$_GET['alpha']."%' ORDER BY FriendFirstName ASC, FriendLastName ASC ";
	...
	/*--------------------------------------------------------------------------------------------------*/
	$query = "SELECT * FROM user_friend_detail WHERE userId = '" . $_SESSION['userId'] . "' and FriendFirstName regexp '^[".$_GET['nextAlpha']."]' ORDER BY FriendFirstName ASC, FriendLastName ASC  limit 0, ".$_GET['secondLimit'];
